...
public class GroupScheduleController {
    ...
    public CommonResponse<ResponseSchedule> createGroupSchedule(@DestinationVariable String groupCode, Schedule groupSchedule) {
        return CommonUtils.success(groupScheduleService.createGroupSchedule(groupCode, groupSchedule));
    }
